...
const InstagramEmbed = ({ urlId, description, dateTime, dateTimeLabel }: InstagramEmbedProps) => (
  <blockquote className="instagram-media" data-instgrm-captioned data-instgrm-permalink={`https://www.instagram.com/p/${urlId}/?utm_source=ig_embed&amp;utm_medium=loading`}
    data-instgrm-version="12" style={{ background: '#FFF', border: '0', borderRadius: '3px', boxShadow: '0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15)', margin: '1px', maxWidth: '540px', minWidth: '326px', padding: '0', width: 'calc(100% - 2px)' }}>
    <div style={{ padding: '16px' }}> <a href={`https://www.instagram.com/p/${urlId}/?utm_source=ig_embed&amp;utm_medium=loading`}
      ...
      <p style={{ margin: '8px 0 0 0', padding: '0 4px' }}> <a href={`https://www.instagram.com/p/${urlId}/?utm_source=ig_embed&amp;utm_medium=loading`}
        ...
        target="_blank">{description}</a></p >
      <p style={{ color: '#c9c8cd', fontFamily: 'Arial, sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: '0', marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}> A
post shared by < a href="https://www.instagram.com/ginteea/?utm_source=ig_embed&amp;utm_medium=loading" style={{ color: '#c9c8cd', fontFamily: 'Arial, sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px', }}
          target="_blank" > GINTARĖ</a > (@ginteea) on <time style={{ fontFamily: 'Arial, sans-serif', fontSize: '14px', lineHeight: '17px', }}
            dateTime={dateTime} > {dateTimeLabel}</time ></p >
    </div >
  </blockquote>
);
